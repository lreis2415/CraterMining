# coding=utf-8
# @Time    : 11/28/2018 00:49 AM
# @Author  : Yanwen Wang

# This file aims to obtain the normalized elevation profiles for positive
# training samples of craters area delineated by experts.
...
# Define θ=0, π/2, π, 3π/2 line. These four lines are skeleton of the lines set.
#          [0, 1]
#  [-1, 0]         [1, 0]
#          [0, -1]
...
print("The time of training positive profile calculation is " + str(calctime)
      + " s.")
